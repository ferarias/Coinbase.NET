...
namespace CoinbaseConnector
{
	...
	public class Connector
    {
		...
		public string GetAccountChanges(int page = 1)
		{
			...
			return JsonRequest(UrlBase + "account_changes?page=" + page, GET);
		}

		// Account - DEPRECATED
		public string GetAccountBalance()
		{
			return JsonRequest(UrlBase + "account/balance", GET);
		}
		public string GetCurrentReceiveAddress()
		{
			return JsonRequest(UrlBase + "account/receive_address", GET);
		}
		public string GenerateReceiveAddress()
		{
			return JsonRequest(UrlBase + "account/generate_receive_address", POST);
		}
		public string GenerateReceiveAddress(String callbackURL, String label)
		{
			return JsonRequest(UrlBase + "account/generate_receive_address?address[callback_url]=" + callbackURL+"&address[label]=" + label, POST); 
		}
		...
		public string GetUserAccounts(int page = 1, int limit = 25, Boolean all_accounts = false)
		{
			...
			return JsonRequest(UrlBase + "accounts" + sb.ToString(), GET);
		}
		public string GetUserAccountBalance(string id)
		{
			return JsonRequest(UrlBase + "accounts/" + id + "/balance", GET);
		}
		public string CreateAccount(string account_name) 
		{
			return JsonRequest(UrlBase + "accounts?account[name]=" + account_name, POST);
		}
		public string UpdateAccountSettings(string id)
		{
			return JsonRequest(UrlBase + "accounts/" + id, PUT);
		}
		public string SetAccountPrimary(string id)
		{
			return JsonRequest(UrlBase + "accounts/" + id + "/primary", POST);
		}
		public string DeleteAccount(string id)
		{
			return JsonRequest(UrlBase + "accounts/" + id, DELETE);
		}
		...
		{
			// Page field is optional. Default is 1
			return JsonRequest(UrlBase + "addresses?page=" + page + "&limit=" + limit + "&query=" + query, GET);
		}

		// OAuth Applications
		public string GetOAuthApplicationsList(int page = 1)
		{
			return JsonRequest(UrlBase + "oauth/applications?page=" + page, GET);
		}
		public string GetOauthApplicationByID(String ID)
		{
			return JsonRequest(UrlBase + "oauth/applications/" + ID, GET);
		}
		public string CreateOAuthApplication(String name, String redirectURI)
		{
			return JsonRequest(UrlBase + "oauth/applications?application[name]=" + name + "&application[redirect_uri]=" + redirectURI, POST);
		}

		// Authorization
		public string GetApplicationAccountAccessInfo()
		{
			return JsonRequest(UrlBase + "authorization", GET);
		}
										  ...
										  String price5 = "")
		{
			...
			return JsonRequest(UrlBase + "buttons" + sb.ToString(), POST);
		}
		public string CreateOrderForButton(String code)
		{
			return JsonRequest(UrlBase + "buttons/" + code + "/create_order", POST);
		}
		...
		public string PurchaseBitcoin(float qty, Boolean agree_btc_amount_varies = false, String payment_method_id = "")
		{
			...
			return JsonRequest(UrlBase + "buys?qty=" + qty + "&agree_btc_amount_varies=" + agree_btc_amount_varies 
		...
		public string GetEmailContactsList(int page = 1, int limit = 25, String query = "")
		{
			...
			return JsonRequest(UrlBase + "contacts" + sb.ToString(), GET);
		}

		// Currencies
		public string GetSupportedCurrenciesList()
		{
			return JsonRequest(UrlBase + "currencies", GET);
		}
		public string GetBTCExchangeRate()
		{
			return JsonRequest(UrlBase + "currencies/exchange_rates", GET);
		}
		...
		{
			// Page field is optional. Default is 1
			return JsonRequest(UrlBase + "orders?page=" + page, GET);
		}
		...
		public string GetTotalBuyPriceForBitcoin(float qty = 1, String currency = "USD")
		{
			...
			return JsonRequest(UrlBase + "prices/buy?qty=" + qty + "&currency=" + currency, GET);
		}
		public string GetTotalSellPriceForBitcoin(float qty = 1, String currency = "USD")
		{
			// qty is optional. Default value is 1.
			// currency is optional. Default value is USD (this is the only supported value at this time.)
			return JsonRequest(UrlBase + "prices/sell?qty=" + qty + "&currency=" + currency, GET);
		}
		public string GetSpotPriceForBitcoin(String currency = "USD")
		{
			// Currency must be an ISO 4217 Currency Code. Default is USD
			return JsonRequest(UrlBase + "prices/spot_rate?currency=" + currency, GET);
		}
		public string GetHistoricalSpotPriceForBitcoin(int page = 1)
		{
			// Page field is optional. Default is 1
			return JsonRequest(UrlBase + "prices/historical?page=" + page, GET);
		}
		...
		public string GetRecurringPaymentsList(String ID = "", int page = 1, int limit = 25)
		{
			...
			if (ID != "") return JsonRequest(UrlBase + "recurring_payments/" + ID, GET);

			return JsonRequest(UrlBase + "recurring_payments?page=" + page + "&limit=" + limit, GET);
		}

		// Reports
		public string GetReportsList()
		{
			return JsonRequest(UrlBase + "reports", GET);
		}
			...
			String accountID = "")
		{
			...
			return JsonRequest(UrlBase + "reports" + sb.ToString(), POST);
		}
		public string GetReportByID(string ID)
		{
			return JsonRequest(UrlBase + "reports" + "/" + ID, GET);
		}
		...
		public string SellBitcoin(float qty, String payment_method_id = "")
		{
			...
			return JsonRequest(UrlBase + "sells?qty=" + qty + "&payment_method_id=" + payment_method_id, POST);	
		}
		...
		public string GetSubscribersList(String ID = "", int page = 1, int limit = 25)
		{
			...
			if (ID != "") return JsonRequest(UrlBase + "subscribers/" + ID, GET);

			return JsonRequest(UrlBase + "subscribers?page=" + page + "&limit=" + limit, GET);
		}
		...
		public string GetTransactionsList(String ID = "", int page = 1, int limit = 25) 
		{
			...
			if (ID != "") return JsonRequest(UrlBase + "transactions/" + ID, GET);

			return JsonRequest(UrlBase + "transactions?page=" + page + "&limit=" + limit, GET);
		}
								...
								Boolean instantBuy = false)
		{
			...
			return JsonRequest(UrlBase + "transactions/send_money" + sb.ToString(), POST);
		}
								  ...
								  String notes = "", String accountID = "")
		{
			...
			return JsonRequest(UrlBase + "transactions/request_money" + sb.ToString(), POST);
		}
		public string ResendInvoice(String ID)
		{
			// This lets the user resend a money request.
			return JsonRequest(UrlBase + "transactions/" + ID + "/resend_request", PUT);
		}
		public string CancelMoneyRequest(String ID)
		{
			...
			return JsonRequest(UrlBase + "transactions/" + ID + "/cancel_request", DELETE);
		}
		public string CompleteMoneyRequest(String ID)
		{
			...
			return JsonRequest(UrlBase + "transactions/" + ID + "/complete_request", PUT);
		}
		...
		public string GetTransfersList(int page = 1, int limit = 25)
		{
			...
			if (limit > 1000) limit = 1000;
			return JsonRequest(UrlBase + "transfers?page=" + page + "&limit=" + limit, GET);
		}
		...
		public string CreateNewUser(String email, String password, String referrerID = "", String clientID = "")
		{
			...
			return JsonRequest(UrlBase + "users" + sb.ToString(), POST);

		}
		public string GetAccountSettings()
		{
			// Show current user with account settings.
			return JsonRequest(UrlBase + "users", GET);
		}
											...
											String nativeCurrency = "", String timeZone = "")
		{
			...
			return JsonRequest(UrlBase + "users/" + id + sb.ToString(), PUT);
		}
		...
		private string JsonRequest(string url, string method)
		{
			...
			if (webRequest != null)
			{
				...
				string signature = HashEncode(HashHMAC(StringEncode(ApiSecret), StringEncode(message)));

				var whc = new WebHeaderCollection();
				whc.Add("ACCESS_KEY: " + ApiKey);
